/**************************************************************************
 ...
 [1] Carlos M. Fonseca, Lu铆s Paquete, and Manuel L贸pez-Ib谩帽ez. An
 ...
 [2] Nicola Beume, Carlos M. Fonseca, Manuel Lopez-Ibanez, Luis
     ...
     Computation, 13(5):1075鈥?1082, 2009.
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    */
    ...
    plhs[0] = mxCreateDoubleMatrix(1, 1, mxREAL);   /* 为输出变量分配内存并传递给mexFunction的输出参数 */
     volume = mxGetPr(plhs[0]);     /* 获取输入矩阵的指针*/
